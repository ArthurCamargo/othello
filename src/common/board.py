...
def from_string(string):
    ...
    b.move_stack.append([b.tiles, b.piece_count])
...
class Board(object):
    ...
    def process_move(self, position, color):
        ...
        old_piece_count = copy.deepcopy(self.piece_count)
        old_legal_moves = copy.deepcopy(self._legal_moves)

        self.move_stack.append([old_tiles, old_piece_count, old_legal_moves])
    ...
    def unprocess_move(self):
        # as the board is represented row-column, swaps coords to col-row
        old_tiles, old_piece_count, old_legal_moves = self.move_stack.pop()
        self.tiles = old_tiles
        self.piece_count = old_piece_count
        self._legal_moves = old_legal_moves
